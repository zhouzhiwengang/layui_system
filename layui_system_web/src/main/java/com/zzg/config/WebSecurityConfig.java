...
import com.zzg.sercurity.filter.JWTLoginFilter;
import com.zzg.sercurity.filter.JWTValidFilter;
import com.zzg.sercurity.filter.VerificationCodeLoginFilter;
import com.zzg.sercurity.provider.VerificationCodeProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.sessionManagement()
			...
			// 资源下载不需要鉴权
			.antMatchers("/upload_file/**").permitAll()
